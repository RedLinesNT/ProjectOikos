...
namespace Oikos.Core {
    ...
    /// <summary>
    /// This class allow to fetch "ScriptableObject" files at runtime.
    /// The files fetched should only be used to read content to avoid GameData modifications at runtime.
    /// </summary>
